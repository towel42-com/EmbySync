...
public:
    ...
    std::shared_ptr< SMediaCollectionData > addMovie( const QString &name, const std::optional< int > &year, const std::optional< std::pair< int, int > > &resolution, const QModelIndex &collectionIndex, const std::optional< int > & rank );
